"""
Este módulo contiene la clase ConfigApp que representa la aplicación de configuración de cada 
celular. Permite gestionar diversas configuraciones del dispositivo, como el nombre, la 
contraseña, el modo de red, el modo avión, entre otros.
"""
...
class ConfigApp(Aplicacion):
    ...
    def configurar_contrasenia(self, contrasenia_nueva, contrasenia_vieja = None):
        ...
        La nueva contraseña debe cumplir con ciertos requisitos de validación.
         
        Args:
            contrasenia_nueva (str): La nueva contraseña que se desea configurar.
            contrasenia_vieja (str, opcional): La contraseña actual del usuario. 
            Si no se proporciona, se asume que no hay una contraseña previa configurada.

        Returns:
            None
            
        Raises:
            ValueError: Si la contraseña actual es incorrecta o si la nueva contraseña 
    ...
    def set_datos(self,valor:bool):
        ...
        Args:
            valor (bool): Si es True, se encienden los datos móviles. Si es False, 
            se apagan los datos móviles.
    ...
    def set_modo_avion(self, valor:bool):
        ...
        if self.configuracion.modo_avion == valor:
            raise ValueError(f"El modo avion ya se encuentra {'encendido' if valor is True else 'apagado'}")
    ...
    def get_modo_red(self):
        """Retorna el modo de red actual del dispositivo."""
